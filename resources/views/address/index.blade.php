					...
					<div class="col s12">
						<form class="contact-form" id="contact-form" >
							<div class="form-group" id="name-field">
								<input type="text" class="validate" id="site_name" name="site_name" placeholder="收货人名字" required>
							</div>
							<div class="form-group" id="email-field">
								<input type="text" class="validate" id="site_tel" name="site_tel" placeholder="收货手机号" required>
							</div>
							<div class="form-group" id="subject-field">
								<input type="text" class="validate" id="province" name="province" placeholder="省区" required>
							</div>
							<div class="form-group" id="subject-field">
								<input type="text" class="validate" id="city" name="city" placeholder="市区" required>
							</div>
							<div class="form-group" id="subject-field">
								<input type="text" class="validate" id="detailed" name="detailed" placeholder="详细地址" required>
							</div>

							<div class="form-group">
								<button class="btn button-default" type="submit" id="submit" name="submit">添加</button>
							</div>
						</form>
					</div>
				</div>
